    ...
    return (
      <Image
        ...
        <View style={styles.container}>
          <Image
            source={require('../images/2017_logo_Capitaine.png')}
            style={styles.logo_img} />
          <Text style={styles.title}>Capitaine</Text>
          <View
            style={{flex:1}}
            onLayout={(e) => this._onLayoutDidChange(e)}>
            <Carousel
              ...
              <View style={[styles.carousel, this.state.size]}>
                ...
                <Text
                  style={styles.carousel_txt}
                  numberOfLines={5}>
                  Préparez votre vol décontracté en consultant votre trajet prédéfini et la météo actuelle en direct
                </Text>
              </View>
              <View style={[styles.carousel, this.state.size]}>
                <Text style={styles.carousel_title}>VOLEZ</Text>
                <Text style={styles.carousel_txt}>
                  Enregistrez vos conversations, partagez votre trajet et servez-vous des services aéronautiques à votre disposition
                </Text>
              </View>
              <View style={[styles.carousel, this.state.size]}>
